        ...
        <div>
            ...
            <div class="relative flex flex-col pt-6 xl:pt-8 2xl:pt-14 pb-14 xl:pb-0">
                ...
                <div class="hidden xl:flex items-center gap-14 xl:translate-x-28 text-xl z-40 text-white">
                    <a href="#about" class="hover:text-[#034532] text-2xl">Sobre nosotros</a>
                    <a href="#contact" class="hover:text-[#034532] text-2xl">Contacto</a>
                </div>
                <div className='flex w-full justify-end'>
                <Button className='bg-[#034532] text-white text-2xl' onClick={() => {router.push("/login/generador")}}> Ingresar</Button>
                </div>
                
                </div>
                <div class="container xl:h-full md:min-h-[38rem] 2xl:min-h-[45rem] flex flex-col items-start justify-center mt-14 xl:mt-8 2xl:mt-10 xl:-translate-y-12 xl:translate-x-10 2xl:translate-x-24 z-10 ">
                <div class="text-5xl sm:text-6xl xl:text-7xl 2xl:text-8xl font-condensed font-normal italic uppercase max-w-2xl leading-none text-white">
                    Gestión y optimización de <span class="hightlighted hightlighted-white">residuos</span>
                </div>
                ...
                <div class="flex items-center mt-10 gap-10 xl:gap-14 xl:ml-2">
                    <a href="#about" class="text-lg text-white font-medium border-b border-white hover:pr-4 transition-all duration-200">Más información</a>
                </div>
                </div>
            ...
            <div class="container mx-auto py-12 xl:pt-24 xl:pb-28">
                ...
                <div class="grid grid-cols-1 xl:grid-cols-2 gap-4 xl:gap-8 justify-center">
                <div class="about-card relative flex gap-16 px-8 py-7 xl:px-11 xl:py-9 border text-white overflow-hidden group hover:shadow-public-card transition-all duration-200">
                    <div>
            ...
            <section id="contact" class="bg-[#057454] text-white relative overflow-hidden">
                <div class="container mx-auto pt-10 pb-6 xl:pt-24 xl:pb-10">
                    ...
                    <div class="flex gap-2 xl:justify-center items-center w-full text-secondary-color font-condensed text-lg uppercase italic mt-10 xl:mt-16">
                    Powered by 
                    <p className="font-bold text-white text-lg"> EcoGestion</p>
                    </div>
                </div>
